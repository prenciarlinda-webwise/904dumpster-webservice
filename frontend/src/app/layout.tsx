...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'roll off dumpster rental jacksonville',
    'roll off dumpster jacksonville fl',
    'cheap dumpster rental jacksonville',
    'jacksonville fl dumpster rental',
    'dumpster jacksonville',
    'trash dumpster rental jacksonville',
    'dumpster service jacksonville fl',
    'small dumpster rental jacksonville fl',
    'roll off dumpster jacksonville',
    'rent a dumpster jacksonville fl',
    'dumpster rentals jacksonville fl',
  ],
