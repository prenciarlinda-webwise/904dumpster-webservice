...
export const metadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Moving dumpster rental in Jacksonville FL for pre-move decluttering and cleanouts',
      },
    ],
    locale: 'en_US',
  },
  twitter: {
    ...
    title: 'Moving Dumpster Rental Jacksonville FL',
    description: 'Declutter before you pack. Roll-off dumpsters for whole-house moves in Jacksonville FL.',
...
const blogPosts = [
  ...
  {
    title: 'Spring Cleaning and Decluttering Guide',
