...
const SERVICE_AREAS = {
  duval: {
    ...
    locations: [
      ...
      { name: 'Mandarin', href: '/dumpster-rental-mandarin-fl', description: 'South Jacksonville service' },
      { name: 'Southside', href: '/residential-dumpster-rental-jacksonville-fl', description: 'Southeast Jacksonville service' },
      { name: 'Riverside', href: '/dumpster-rental-riverside-avondale-fl', description: 'Historic district service' },
      { name: 'Avondale', href: '/dumpster-rental-riverside-avondale-fl', description: 'Historic Avondale/Riverside service' },
      { name: 'San Marco', href: '/dumpster-rental-san-marco-fl', description: 'Historic San Marco service' },
    ],
  },
  stJohns: {
