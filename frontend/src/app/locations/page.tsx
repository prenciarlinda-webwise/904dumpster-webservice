...
const SERVICE_AREAS = {
  duval: {
    ...
    locations: [
      ...
      { name: 'Mandarin', href: '/residential-dumpster-rental-jacksonville-fl', description: 'South Jacksonville service' },
      { name: 'Southside', href: '/residential-dumpster-rental-jacksonville-fl', description: 'Southeast Jacksonville service' },
      { name: 'Riverside', href: '/residential-dumpster-rental-jacksonville-fl', description: 'Historic district service' },
      { name: 'Avondale', href: '/residential-dumpster-rental-jacksonville-fl', description: 'Historic Avondale/Riverside service' },
      { name: 'San Marco', href: '/residential-dumpster-rental-jacksonville-fl', description: 'Historic San Marco service' },
    ],
  },
  stJohns: {
