...
export const POSTS_46_TO_55: BlogPost[] = [
  // Post 46
  {
...
## How Much Waste Does a Porch Project Produce?
...
|---|---|---|
| Enclosing an existing open porch (no slab work) | 2-4 cubic yards | [10-yard dumpster](/10-yard-dumpster-rental) |
| Replacing an old screened porch | 4-8 cubic yards | [15-yard dumpster](/15-yard-dumpster-rental) |
| New screened porch with slab demolition | 6-12 cubic yards | [15-yard](/15-yard-dumpster-rental) or [20-yard dumpster](/20-yard-dumpster-rental) |
| Large custom screened porch with roof work | 10-15 cubic yards | [20-yard dumpster](/20-yard-dumpster-rental) |

For most standard screened-in porch projects in Jacksonville, a [15-yard dumpster](/15-yard-dumpster-rental) provides enough capacity to handle both demolition debris and new construction waste. If your project includes heavy concrete removal, you may want a separate load or a heavier-rated container.
...
## Planning Waste Removal Before the Project Starts
...
## Waste Planning for Specific Porch Scenarios

### Converting a Patio to a Screened Porch

If you already have a concrete patio and are adding a roof and screen enclosure above it, waste is relatively minimal. Expect old patio furniture disposal, any removed railings or planters, packaging from new materials, and wood scraps from framing. A [10-yard dumpster](/10-yard-dumpster-rental) is usually sufficient for this type of conversion.

### Tearing Down and Rebuilding an Old Screen Porch

Older screen porches in Jacksonville often have aluminum frames that have corroded in the salt air, especially in beach communities like [Jacksonville Beach](/dumpster-rental-jacksonville-beach-fl), [Atlantic Beach](/dumpster-rental-atlantic-beach-fl), and [Ponte Vedra](/dumpster-rental-ponte-vedra-fl). Tearing down an existing structure and rebuilding generates the most waste. Old framing, screening, roofing, and sometimes the flooring all need disposal. A [15-yard dumpster](/15-yard-dumpster-rental) handles most tear-down-and-rebuild projects.
...
For homeowners in [St. Augustine](/dumpster-rental-st-augustine-fl), [Orange Park](/dumpster-rental-orange-park-fl), and [Fleming Island](/dumpster-rental-fleming-island-fl), we offer the same fast delivery and flat-rate pricing. No matter where your porch project is in Northeast Florida, we can get a dumpster to your property quickly.

## How to Book a Dumpster for Your Porch Project

Getting a dumpster from 904 Dumpster is simple. [Book online 24/7](https://app.icans.ai/customer-portal/904dumpster/book/) or call us at **(904) 240-5598**. Every rental includes delivery, pickup, disposal, and a generous rental period with no hidden fees. Check our [dumpster rental pricing page](/dumpster-rental-pricing-jacksonville) for current rates and availability.

## Frequently Asked Questions

### How much debris does a screened-in porch project produce?

A typical screened-in porch conversion generates 2 to 8 cubic yards of debris, depending on whether you are enclosing an existing structure or tearing down and rebuilding. Projects that involve concrete slab removal or full roof work can produce 10 to 15 cubic yards. Our [dumpster size guide](/dumpster-size-guide) can help you estimate the right container.

### What dumpster size do I need for a porch project?

Most screened-in porch projects in Jacksonville fit comfortably in a [15-yard dumpster](/15-yard-dumpster-rental). Smaller conversions without demolition may only need a [10-yard](/10-yard-dumpster-rental), while large projects with concrete removal may require a [20-yard](/20-yard-dumpster-rental).

### Can I put old screen panels and aluminum framing in a dumpster?
...
### How long should I keep the dumpster during a porch project?
...
### Do I need a permit for a dumpster in my driveway during a porch project?
...
A roof leak is one of those home problems that demands immediate attention. Left unaddressed, even a small leak can lead to mold growth, structural damage, ruined insulation, and thousands of dollars in additional repairs. For [Jacksonville](/15-yard-dumpster-rental) homeowners, the combination of heavy summer thunderstorms, hurricane season, and intense UV exposure means roofs take a beating year-round. Knowing how to find a roof leak, what the repair process involves, and how to plan for the resulting waste puts you in control of the situation instead of scrambling to react.

Roofing debris is heavy and time-sensitive, and [904 Dumpster](/dumpster-rental-pricing-jacksonville) has hauled it across Jacksonville and Northeast Florida since 2016, in 10, 15, and 20-yard sizes from $299.
...
[Book online 24/7](https://app.icans.ai/customer-portal/904dumpster/book/) or call us at **(904) 240-5598**. Visit our [pricing page](/dumpster-rental-pricing-jacksonville) for current rates on all dumpster sizes. If you are unsure which size you need, our team can help you estimate based on your roof size and project scope. You can also consult our [dumpster sizes explained guide](/blog/dumpster-sizes-explained-complete-guide) for a detailed comparison.

## Frequently Asked Questions

### How do I find a roof leak from inside the house?
...
A full roof replacement on a typical Jacksonville home generates between 3 and 5 tons of waste, primarily old asphalt shingles, underlayment, and damaged decking. A [20-yard dumpster](/20-yard-dumpster-rental) handles most full replacements. Smaller section repairs produce less waste and may only need a [10-yard](/10-yard-dumpster-rental) or [15-yard dumpster](/15-yard-dumpster-rental).
...
### Do I need a dumpster for a small roof repair?

For a minor patch repair involving just a few shingles and a vent boot, heavy-duty trash bags may be enough. For anything involving more than about 50 square feet of roof area, a [10-yard dumpster](/10-yard-dumpster-rental) makes the cleanup much easier and keeps sharp nails and debris contained safely.
`,
  },
  // Post 48
  {
...
Flooring tear-outs are dense, weight-limited jobs, and [904 Dumpster](/dumpster-rental-pricing-jacksonville) has served Jacksonville since 2016 with 10, 15, and 20-yard containers starting at $299.
...
## Waste Estimates by Project Size

| Project | Estimated Debris Weight | Estimated Volume | Recommended Dumpster |
|---|---|---|---|
| Single room carpet removal | 100-200 lbs | Under 1 cubic yard | Trash bags or [10-yard](/10-yard-dumpster-rental) |
| Whole-house carpet removal (1,500 sq ft) | 400-800 lbs | 2-3 cubic yards | [10-yard dumpster](/10-yard-dumpster-rental) |
| Single room tile removal | 500-1,500 lbs | 1-2 cubic yards | [10-yard dumpster](/10-yard-dumpster-rental) |
| Whole-house tile removal (1,200 sq ft) | 3,000-6,000 lbs | 4-8 cubic yards | [15-yard](/15-yard-dumpster-rental) or [20-yard dumpster](/20-yard-dumpster-rental) |
| Laminate removal (whole house) | 300-600 lbs | 2-3 cubic yards | [10-yard dumpster](/10-yard-dumpster-rental) |
| Hardwood removal with subfloor damage | 1,000-3,000 lbs | 3-5 cubic yards | [15-yard dumpster](/15-yard-dumpster-rental) |
...
## Wood Floor Refinishing vs. Replacement
...
Some flooring materials can be recycled in Jacksonville. Clean concrete and tile can sometimes be accepted at concrete recycling facilities. Metal transition strips and thresholds have scrap value. Carpet recycling is limited but growing. For information on recycling construction materials in Jacksonville, see our [recycling guide for construction projects](/blog/recycling-guide-jacksonville-construction-projects).

We deliver dumpsters throughout Northeast Florida including [Ponte Vedra](/dumpster-rental-ponte-vedra-fl), [Middleburg](/dumpster-rental-middleburg-fl), [Green Cove Springs](/dumpster-rental-green-cove-springs-fl), and surrounding communities. [Book online](https://app.icans.ai/customer-portal/904dumpster/book/) or call **(904) 240-5598**.

## Frequently Asked Questions

### How much does it cost to dispose of old flooring?

A [10-yard dumpster](/10-yard-dumpster-rental) starting at $299 handles most single-room or whole-house carpet and laminate removals. Tile removal for an entire home may require a [15-yard](/15-yard-dumpster-rental) ($349) or [20-yard](/20-yard-dumpster-rental) ($399) dumpster due to the weight and volume of tile and mortar.

### Can I put tile and mortar in a dumpster?
...
### How much waste does carpet removal create?
...
### Can old laminate flooring be recycled?
...
### Do I need to remove baseboards before flooring removal?
...
Whether you are buying [an older home in Jacksonville](/dumpster-rental-pricing-jacksonville), preparing a property for sale, or planning a renovation, building code violations can throw a wrench into your timeline and budget. Common building code violations range from unpermitted additions and improper electrical work to missing smoke detectors and inadequate egress windows. Correcting these house code violations often means tearing out non-compliant work and starting over, which creates construction debris that needs proper disposal. Understanding the most frequent home violations and what fixing them involves helps you plan ahead for both the renovation work and the waste it produces.

[904 Dumpster](/dumpster-rental-pricing-jacksonville), locally owned in Jacksonville since 2016, offers 10, 15, and 20-yard roll-off containers starting at $299 flat for code-compliance cleanups.
...
When unpermitted work has to be corrected, it often means partially or fully demolishing the addition and rebuilding it to code. The waste from demolishing an unpermitted garage conversion or poorly built room addition can easily fill a [20-yard dumpster](/20-yard-dumpster-rental). Drywall, framing lumber, insulation, flooring, and fixtures all come out.
...
If you are in the market for an older Jacksonville home, particularly in historic neighborhoods like Springfield, [Riverside](/dumpster-rental-riverside-avondale-fl), Avondale, or [San Marco](/dumpster-rental-san-marco-fl), knowing things to look for when buying an old house can save you from costly surprises.

| What to Check | Why It Matters | Potential Waste If Fixed |
|---|---|---|
| Permit history | Reveals unpermitted work | Demolition debris from removal |
| Electrical panel and wiring | Older homes may have outdated systems | Old wiring, panel, drywall patches |
| Plumbing material (galvanized, polybutylene) | Certain materials are failure-prone | Old pipes, drywall, flooring |
| Roof age and condition | Florida roofs deteriorate faster | Shingles, underlayment, decking |
| Foundation and grading | Settling causes structural issues | Concrete, soil, landscaping debris |
| Attic and garage conversions | Common unpermitted modifications | Full renovation debris if non-compliant |
...
## How Code Violation Repairs Generate Waste
...
When systems like electrical wiring, plumbing pipes, or HVAC ductwork are replaced to meet code, the old materials become waste. Old galvanized pipes, outdated electrical panels, and deteriorated ductwork all need disposal. Some metals can be recycled at Jacksonville scrap yards. See our [recycling guide](/blog/recycling-guide-jacksonville-construction-projects) for more details.
...
Have your contractor provide a written scope of work that includes an estimate of debris volume. A small code correction project like adding egress windows might only need a [10-yard dumpster](/10-yard-dumpster-rental). A major project like demolishing an unpermitted addition likely needs a [15-yard](/15-yard-dumpster-rental) or [20-yard dumpster](/20-yard-dumpster-rental).

### Time the Dumpster Delivery

Schedule dumpster delivery for the day demolition begins. Code correction projects often start with the biggest debris-producing phase, so you want the container ready from day one. For projects in [Orange Park](/dumpster-rental-orange-park-fl), [St. Augustine](/dumpster-rental-st-augustine-fl), [Fleming Island](/dumpster-rental-fleming-island-fl), and other Northeast Florida communities, we offer fast delivery, often same-day or next-day.
...
For more guidance on planning renovation waste, read our [complete guide to roll-off dumpster rental](/blog/roll-off-dumpster-rental-complete-guide) or visit our [dumpster rental pricing page](/dumpster-rental-pricing-jacksonville). [Book a dumpster online](https://app.icans.ai/customer-portal/904dumpster/book/) or call us at **(904) 240-5598**.
...
### Do you need a permit to finish an attic in Jacksonville?
...
### How much waste does correcting a code violation produce?

It depends on the violation. Adding a missing egress window might fill a few trash bags. Demolishing an unpermitted room addition can fill a [15-yard](/15-yard-dumpster-rental) or [20-yard dumpster](/20-yard-dumpster-rental). Whole-house electrical or plumbing replacement with wall access generates moderate drywall and material waste, typically fitting in a [10-yard dumpster](/10-yard-dumpster-rental).

### Can I do code correction work myself?
...
A standard bathroom demolition produces these approximate weights:

| Item Removed | Approximate Weight |
|---|---|
| Ceramic tile (floor and walls, 80 sq ft) | 400-800 lbs |
| Cast iron bathtub | 300-400 lbs |
| Fiberglass tub/shower unit | 50-80 lbs |
| Vanity with countertop | 50-150 lbs |
| Toilet | 60-80 lbs |
| Water-damaged drywall | 50-200 lbs |
| Old flooring and underlayment | 50-150 lbs |
...
Laundry room renovations vary widely in scope. Some homeowners focus on cosmetic updates like new cabinets and flooring, while others relocate plumbing, add utility sinks, and reconfigure the entire space. Here is what to expect for waste based on the renovation scope.

### Cosmetic Laundry Room Update

Replacing cabinets, countertops, flooring, and paint produces old cabinetry, countertop material, flooring debris, and general packaging. This level of renovation typically generates 200 to 500 pounds of waste.

### Full Laundry Room Gut Renovation

A complete laundry renovation that includes plumbing relocation, new flooring, new cabinets, wall modifications, and potentially moving the washer/dryer hookups generates more significant waste. Old drywall, flooring, cabinets, plumbing fixtures, and sometimes structural framing all come out. Laundry renovation cost is often higher than homeowners expect, and waste disposal should be factored into the laundry room renovation price from the start.

## Dumpster Sizing for Bathroom and Laundry Projects

| Project Scope | Estimated Waste | Recommended Dumpster |
|---|---|---|
| Single bathroom cosmetic update | 200-400 lbs | Large trash bags or [10-yard](/10-yard-dumpster-rental) |
| Single full bathroom gut remodel | 500-1,500 lbs | [10-yard dumpster](/10-yard-dumpster-rental) |
| Multiple bathroom remodel | 1,500-4,000 lbs | [15-yard dumpster](/15-yard-dumpster-rental) |
| Bathroom + laundry room combo renovation | 1,000-3,000 lbs | [15-yard dumpster](/15-yard-dumpster-rental) |
| Whole-house bathroom renovation (3+ bathrooms) | 3,000-6,000 lbs | [20-yard dumpster](/20-yard-dumpster-rental) |
...
## Planning Waste Disposal Before the Renovation
...
Before the sledgehammer comes out, remove anything worth saving or donating. Vanities, mirrors, light fixtures, and toilets in good condition can be donated to Habitat for Humanity ReStore in Jacksonville or sold on Facebook Marketplace. Even if you are doing a bathroom remodel for cheap, the disposal savings from donating working fixtures instead of dumping them add up.
...
Overestimating and renting a dumpster that is too large wastes money. Underestimating and needing a second haul costs even more. For a single bathroom remodel, a [10-yard dumpster](/10-yard-dumpster-rental) at $299 is almost always sufficient. Only step up to a [15-yard](/15-yard-dumpster-rental) if you are remodeling multiple bathrooms or combining the bathroom with other renovation work.

### Donate Before You Demo

Every fixture you donate instead of throwing away reduces dumpster weight and extends the capacity for other debris. Functioning toilets, sinks, vanities, and lighting fixtures all have value to someone, and donating them costs nothing.

### Combine Projects

If you are renovating a bathroom and a laundry room, or doing multiple bathrooms at once, one dumpster for the combined project is more economical than separate dumpsters for each. Planning multiple rooms at once also means the contractor only mobilizes once, reducing labor costs on top of disposal savings.

## Specific Waste Challenges in Jacksonville Renovations

Jacksonville's climate creates some unique waste challenges in bathroom and laundry renovations.

### Mold-Damaged Materials

Florida's humidity means bathrooms with poor ventilation often develop mold behind walls and under floors. When demolition reveals mold-damaged drywall, insulation, or subfloor, those materials need to be removed and disposed of. Mold-damaged drywall is heavier than dry drywall because of moisture absorption. Budget for extra disposal capacity if your pre-renovation inspection suggests moisture problems.
...
### How much waste does a bathroom remodel produce?

A single full bathroom gut remodel produces 500 to 1,500 pounds of waste depending on the materials. Tile-heavy bathrooms with cast iron tubs are at the higher end. A standard bathroom remodel fits in a [10-yard dumpster](/10-yard-dumpster-rental). Multiple bathrooms may require a [15-yard](/15-yard-dumpster-rental).

### What is the order of a bathroom remodel?

The standard bathroom remodel order is: demolition, plumbing and electrical rough-in, subfloor repair, waterproofing, wall preparation, tile installation, vanity and fixture installation, and final finishing. The demolition phase generates the most waste, so have your dumpster ready before that first day.

### How much does a laundry room renovation cost for disposal?

Disposal costs for a laundry room renovation range from $299 to $399 for a dumpster rental from 904 Dumpster, depending on the scope of work and the dumpster size needed. Most laundry room renovations fit in a [10-yard dumpster](/10-yard-dumpster-rental) at $299. Factor this into your total laundry room renovation price during the planning phase.

### Can I put a toilet or bathtub in a dumpster?

Yes. Toilets, bathtubs (including cast iron), sinks, vanities, shower enclosures, and other bathroom fixtures are accepted in our dumpsters. Cast iron tubs are extremely heavy, so account for their weight when estimating total waste.

### How do I dispose of bathroom tile and mortar?

Tile and mortar can go directly into a roll-off dumpster. They are heavy materials, so be aware of weight limits. For a single bathroom, tile and mortar debris typically ranges from 400 to 800 pounds. This is well within the capacity of a [10-yard dumpster](/10-yard-dumpster-rental).

### Should I rent a dumpster for a cosmetic bathroom update?

If your update is limited to painting, replacing fixtures, and swapping a vanity without any tile or drywall removal, you may not need a dumpster. Heavy-duty trash bags can handle light renovation debris. But if you are removing any tile, tearing out drywall, or replacing flooring, a dumpster makes the project much easier and cleaner.
`,
  },
  // Post 51
  {
...
Replacing old appliances is a routine part of homeownership, but figuring out what to do with the old ones is rarely as simple as dragging them to the curb. Old refrigerators, water heaters, dishwashers, ovens, washing machines, and dryers are too heavy and bulky for regular trash pickup, and some contain materials that require special handling. [Jacksonville](/dumpster-rental-pricing-jacksonville) homeowners regularly ask us where to throw away appliances, whether the garbage man will take a hot water heater, and if you can take a dishwasher to the dump. The answers depend on the appliance type, its condition, and which disposal method works best for your situation.

Old appliances add weight fast, and [904 Dumpster](/dumpster-rental-pricing-jacksonville) has hauled them out of Jacksonville homes since 2016, with 10, 15, and 20-yard roll-off containers starting at $299 flat.
...
|---|---|---|
| City bulk pickup | Free (Jacksonville residents) | Single appliance, no rush |
| Scrap yard drop-off | Free to small payment received | Working vehicle available, 1-2 appliances |
| Retailer haul-away | $0-$50 per appliance | Buying a new appliance |
...
We deliver dumpsters for appliance disposal throughout Northeast Florida including [St. Augustine](/dumpster-rental-st-augustine-fl), [Orange Park](/dumpster-rental-orange-park-fl), [Fernandina Beach](/dumpster-rental-fernandina-beach-fl), [Atlantic Beach](/dumpster-rental-atlantic-beach-fl), and [Green Cove Springs](/dumpster-rental-green-cove-springs-fl). No matter where you are in the Jacksonville metro area, we can get a dumpster to you quickly.

[Book a dumpster online](https://app.icans.ai/customer-portal/904dumpster/book/) or call us at **(904) 240-5598**. Check our [pricing page](/dumpster-rental-pricing-jacksonville) for current rates.

## Frequently Asked Questions

### Will the garbage man take a hot water heater in Jacksonville?
...
### Where can I throw away appliances in Jacksonville?
...
### Can I put a washing machine in a dumpster?
...
### How much does it cost to get rid of old appliances?
...
## How to Dispose of Gravel from Drainage Projects
...
## How to Dispose of Landscape Rocks
...
Broken or deteriorated rocks and stone that cannot be reused should go in a dumpster. Like gravel, rocks are heavy, so account for weight when planning disposal. For large volumes of rock combined with other drainage debris, a [15-yard dumpster](/15-yard-dumpster-rental) or [20-yard dumpster](/20-yard-dumpster-rental) provides the necessary capacity.
...
We deliver dumpsters for drainage projects throughout Northeast Florida including [Orange Park](/dumpster-rental-orange-park-fl), [Fleming Island](/dumpster-rental-fleming-island-fl), [Ponte Vedra](/dumpster-rental-ponte-vedra-fl), and [Middleburg](/dumpster-rental-middleburg-fl). For information on disposing of rocks, dirt, and landscaping materials in more detail, see our companion guide on [how to dispose of rocks, dirt, and landscaping materials](/blog/how-to-dispose-of-rocks-dirt-landscaping).

[Book a dumpster online](https://app.icans.ai/customer-portal/904dumpster/book/) or call us at **(904) 240-5598**.

## Frequently Asked Questions

### How do I get rid of excess dirt from a yard drainage project?
...
Gravel removal cost depends on the volume and disposal method. A [10-yard dumpster](/10-yard-dumpster-rental) at $299 can hold several cubic yards of gravel within weight limits. For very large gravel volumes, multiple loads or a larger [15-yard dumpster](/15-yard-dumpster-rental) at $349 may be needed.

### Can I put dirt and rocks in a dumpster?
...
### Where can I take dirt in Jacksonville?
...
### What do I do with old landscape rocks?
...
### Who should I call for yard drainage problems in Jacksonville?
...
Moving day generates more discarded items than most people plan for, and [904 Dumpster](/dumpster-rental-pricing-jacksonville) has helped Jacksonville movers clear them since 2016, with 10, 15, and 20-yard containers from $299.

## Why Decluttering Before a Move Saves Money

Moving companies charge by weight and volume, or by the hour for local moves. Every item you move costs money. A whole house junk removal before moving day can save hundreds or even thousands of dollars on your moving bill. Consider these numbers:

| Item | Approximate Weight | Space Used |
|---|---|---|
| Old sofa | 150-250 lbs | 35-50 cubic feet |
| Queen mattress and box spring | 120-180 lbs | 30-40 cubic feet |
| Old dresser | 100-200 lbs | 20-30 cubic feet |
| Boxes of forgotten items (per box) | 20-50 lbs | 2-4 cubic feet |
| Old exercise equipment | 50-300 lbs | 10-50 cubic feet |

If you are paying movers $100 to $200 per hour for a local move, every additional hour spent loading, transporting, and unloading items you do not want adds to the bill. For long-distance moves charged by weight, the savings from decluttering can be even more significant.

## Room-by-Room Decluttering Strategy

### Start Early

Begin decluttering at least four to six weeks before your move date. Trying to sort, sell, donate, and dispose of items during the final packing week creates chaos. Starting early gives you time to sell valuable items, schedule donations, and arrange waste disposal.

### Living Room

The living room often contains the biggest items to evaluate: sofas, armchairs, entertainment centers, coffee tables, and bookshelves. If your old sofa is stained, sagging, or will not fit in the new home, this is the time for old sofa disposal rather than paying to move it. The same goes for entertainment centers and oversized furniture that may not suit the new space.

### Bedrooms

Old mattresses are among the most common items people want to leave behind. The cheapest mattress removal option in [Jacksonville](/10-yard-dumpster-rental) is putting it in a dumpster rental along with other items you are getting rid of. Mattresses are accepted in our dumpsters with no special requirements. Clothing, shoes, and linens in good condition can be donated to local charities.

### Garage and Storage Areas

The garage is usually the biggest source of pre-move decluttering waste. Old paint cans, broken tools, half-used bags of fertilizer, holiday decorations you never display, and boxes that have not been opened since the last move are all prime candidates for disposal. For a thorough approach, see our [garage cleanout guide for Jacksonville homeowners](/blog/garage-cleanout-guide-jacksonville).

### Kitchen

Kitchen decluttering produces less volume but still adds up. Old small appliances, mismatched dishes, expired pantry items, and worn-out cookware can all go. Functioning kitchen items in good condition are excellent donation candidates.

## What to Do with Old Furniture Before a Move

Where to put old furniture is a question every mover faces. You have several options in Jacksonville.

### Sell It

If your furniture is in good condition, selling it before the move puts money in your pocket. Host a yard sale, list items on Facebook Marketplace or OfferUp, or sell through consignment shops. Yard sale tips for pre-move sales: price to sell, not to maximize profit. You want items gone, not to negotiate for weeks. Advertise on Nextdoor and community Facebook groups a week before the sale. Price large items low and be prepared to negotiate. Anything left at the end of the sale goes in the dumpster or to donation.
...
Can i leave furniture on the curb? In Jacksonville, leaving furniture on the curb without scheduling a bulk pickup is technically a code violation. However, it is a common practice. The risk is that if nobody takes it and it is not part of a scheduled pickup, you could receive a notice from code enforcement. The more reliable approach is to schedule a city bulk pickup or place unwanted furniture in a dumpster.

How to get furniture picked up for trash? Jacksonville residents can schedule a bulk pickup through the City's Solid Waste Division at 630-CITY. Items must be placed at the curb on the scheduled pickup day. For items that are too heavy or too many for one bulk pickup, a dumpster rental handles everything in one trip.
...
## Dumpster Rental vs. Other Disposal Methods for Moving

When you are decluttering an entire house before a move, the waste adds up fast. Here is how a dumpster rental compares to other disposal methods.

| Method | Cost | Best For |
|---|---|---|
| Dumpster rental (10-yard) | $299 | Moderate declutter, apartment or small home |
| Dumpster rental (15-yard) | $349 | Full house declutter with furniture |
| Dumpster rental (20-yard) | $399 | Large home, garage, and yard cleanup |
| Whole house junk removal service | $500-$2,000+ | No physical ability to load, need labor |
| City bulk pickup | Free | 1-2 large items, flexible timeline |
| Multiple dump runs (DIY) | $50-$200+ per trip | Small volume, have truck available |

For most Jacksonville families preparing for a move, a [15-yard dumpster](/15-yard-dumpster-rental) provides the best balance of capacity and cost. It holds the equivalent of about 6 pickup truck loads, which covers a typical whole-house declutter including several pieces of furniture, boxes of miscellaneous items, and general household waste.

## Timeline for Pre-Move Decluttering

**6 Weeks Before:** Start sorting room by room. Identify items to sell, donate, and dispose. List high-value items for sale online.

**4 Weeks Before:** Host a yard sale for sellable items. Schedule donation pickups. Begin packing items you are keeping.

**2 Weeks Before:** Order your dumpster from 904 Dumpster. Schedule delivery for 7 to 10 days before moving day. This gives you a full week to load at your own pace.

**1 Week Before:** Load remaining unwanted items into the dumpster. Final donations. Focus on packing what is going with you.

**Moving Day:** The dumpster should already be loaded with everything you are leaving behind. You focus solely on loading the moving truck with items you are taking.

## Moving Waste Disposal in Northeast Florida
...
### How much does it cost to declutter before a move?

A dumpster rental for pre-move decluttering starts at $299 for a [10-yard dumpster](/10-yard-dumpster-rental) and goes up to $399 for a [20-yard dumpster](/20-yard-dumpster-rental). Most households fit their decluttering waste in a [15-yard dumpster](/15-yard-dumpster-rental) at $349. Professional whole house junk removal services charge $500 to $2,000 or more depending on volume.

### Can I leave furniture on the curb in Jacksonville?

Leaving furniture on the curb without a scheduled pickup is a code violation in Jacksonville, though it is commonly done. The proper approach is to schedule a bulk pickup through the city at 630-CITY or place items in a dumpster rental. Scheduled bulk pickup is free for city residents.

### What is the cheapest way to get rid of a mattress?

The cheapest mattress removal option is placing it in a dumpster you have already rented for other decluttering. If you only need to get rid of one mattress, scheduling a free city bulk pickup is the most affordable option. Mattresses are accepted in all of our dumpster sizes.

### How far in advance should I start decluttering before a move?

Start at least four to six weeks before your move date. This gives you time to sell valuable items, schedule donation pickups, and load a dumpster at a comfortable pace without the stress of last-minute disposal.

### Where can I donate furniture in Jacksonville?

Habitat for Humanity ReStore, The Salvation Army, and Goodwill all accept furniture donations in Jacksonville. Many churches and local nonprofits also accept household items. Schedule pickups early because wait times can be one to two weeks during busy seasons.
...
When you have a pile of debris, a house full of junk, or a renovation producing waste, you need a way to get rid of it. The two most common options are renting a roll-off dumpster and hiring a junk removal service. Both get the job done, but they work in fundamentally different ways, cost different amounts, and suit different situations. Choosing the wrong one can mean paying more than you need to or not getting the service you actually need. This guide breaks down the real differences so you can make the right call for [your specific project in Jacksonville](/dumpster-rental-pricing-jacksonville).

[904 Dumpster](/dumpster-rental-pricing-jacksonville) has offered both dumpster rental and disposal guidance across Jacksonville since 2016, with 10, 15, and 20-yard containers starting at $299.

## How Dumpster Rental Works

A dumpster rental is straightforward. You choose a dumpster size, we deliver it to your driveway or property, and you fill it on your own schedule during the rental period. When you are done, you call and we pick it up and haul everything to the appropriate disposal facility. The labor of loading is yours. The convenience is that the container sits there for days, available whenever you are ready to work.
...
We offer three sizes: a [10-yard dumpster](/10-yard-dumpster-rental) at $299, a [15-yard dumpster](/15-yard-dumpster-rental) at $349, and a [20-yard dumpster](/20-yard-dumpster-rental) at $399. For a detailed comparison of what each size holds, read our [dumpster sizes explained guide](/blog/dumpster-sizes-explained-complete-guide).

## How Junk Removal Works

A junk removal service sends a crew to your property. They show up, load everything you want removed onto their truck, and haul it away. The labor is included. You point to what you want gone, and they do the physical work. Most junk removal companies charge based on volume, meaning how much of their truck your items fill, plus the labor involved.

### What You Get with Junk Removal

- A crew that does the physical loading
- Same-day or next-day service in most cases
- Items removed from inside your home, garage, or yard
- Quick turnaround, usually completed in one visit
- No container left on your property
...
| **Pricing transparency** | Flat rate, no surprises | Volume-based estimate, may vary |
...
A whole-house declutter, estate cleanout, or pre-move purge produces waste over several days as you sort room by room. A dumpster gives you the space and time to work through the process at your own pace. You do not have to have everything ready for a single pickup window, and you can change your mind about items as you go.

### When You Have Help

If you have family, friends, or hired labor to help load, a dumpster rental saves significant money compared to a junk removal service. The dumpster itself costs less, and the labor savings are the primary advantage. You are essentially paying for the container and hauling only, not for someone else's time and physical effort.

### Budget-Conscious Projects

For homeowners looking for a budget roll off option, dumpster rental provides the most disposal capacity per dollar. At $299 for a [10-yard dumpster](/10-yard-dumpster-rental), you get space for the equivalent of 4 pickup truck loads. A junk removal service for the same volume would typically cost $400 to $600 or more.
...
### You Cannot Do the Physical Work

Not everyone can load heavy furniture, haul debris, or spend hours moving materials into a dumpster. If you have physical limitations, a health condition, or simply no one to help, a junk removal crew handles the labor. They will carry items from inside your home, up or down stairs, and through tight spaces.

### You Need It Done Today

Junk removal services typically offer same-day or next-day appointments. If you have a time-sensitive situation like a property that needs to be cleared before a closing or a landlord cleaning out an apartment between tenants, the speed of a junk removal crew is the primary advantage. Dumpster delivery is usually same-day or next-day as well, but loading is up to you and takes time.

### Small Volume, Heavy Items

If you have just a few heavy items to get rid of, like an old hot tub, a piano, or a cast iron bathtub, junk removal is often the practical choice. Renting a whole dumpster for a single item may be overkill unless you have other debris to go with it.
...
**Junk Removal:** A full garage typically fills half to three-quarters of a junk truck. Most junk removal companies in Jacksonville quote $350 to $600 for a half to three-quarter truck load. Total cost: $350-$600.
...
**Junk Removal:** Whole house junk removal in Jacksonville typically costs $1,500 to $3,000 or more depending on the volume and number of truck loads. Total cost: $1,500-$3,000.
...
**Junk Removal:** $75 to $150 for a single large item like a sofa or mattress. Total cost: $75-$150.

**Savings with junk removal: $125-$200.**
...
1. **Do I have help?** If yes, dumpster rental. If no and items are heavy, junk removal.
2. **Is my project ongoing or one-time?** Ongoing projects need a dumpster. One-time cleanups can go either way.
3. **What is my budget?** Dumpster rental is almost always cheaper when you can do the loading.
...
In most cases, yes. A dumpster rental from 904 Dumpster starts at $299 for a [10-yard container](/10-yard-dumpster-rental) with flat-rate pricing. Junk removal services in Jacksonville typically charge $200 to $800 or more based on volume, plus labor. For any project larger than a single piece of furniture, dumpster rental is the more affordable option.

### How much does whole house junk removal cost in Jacksonville?

Whole house junk removal in Jacksonville typically costs $1,500 to $3,000 depending on the volume of items and the number of truck loads required. By comparison, a [15-yard dumpster rental](/15-yard-dumpster-rental) at $349 or a [20-yard dumpster rental](/20-yard-dumpster-rental) at $399 provides significant capacity for a fraction of the cost if you can do the loading.

### What are junk pods and how do they compare?

Junk pods are portable storage containers that work similarly to dumpster rentals. You load them and the company picks them up. They tend to be more expensive than traditional roll-off dumpsters and hold less volume. A standard roll-off dumpster from 904 Dumpster provides better value for most projects in Jacksonville.

### Can I rent a dumpster and have someone else load it?

Absolutely. Many Jacksonville homeowners rent a dumpster from us and hire day laborers, friends, or a moving crew to do the loading. This gives you the cost savings of a dumpster rental with the labor assistance of a junk removal service, often at a lower combined cost than hiring a full-service junk removal company.

### How quickly can I get a dumpster delivered?

904 Dumpster offers same-day and next-day delivery throughout Jacksonville and Northeast Florida including [St. Augustine](/dumpster-rental-st-augustine-fl), [Orange Park](/dumpster-rental-orange-park-fl), [Fernandina Beach](/dumpster-rental-fernandina-beach-fl), and surrounding communities. [Book online](https://app.icans.ai/customer-portal/904dumpster/book/) or call **(904) 240-5598**.
`,
  },
  // Post 55
  {
...
Landscaping projects are among the most satisfying home improvements, but they also produce some of the heaviest and most difficult-to-dispose-of waste. Rocks, dirt, old mulch, gravel, concrete pavers, lava rocks, and other hardscape materials do not fit in your regular trash bin and cannot simply be left in a pile on the curb. Whether you are redesigning your entire yard, removing an old rock garden, tearing out a paver patio, or just getting rid of extra dirt from a grading project, you need a plan for handling this heavy, bulky material. [Jacksonville homeowners](/20-yard-dumpster-rental) have several disposal options depending on the material type, volume, and condition.

Rock and dirt are dense enough to hit a weight limit fast, and [904 Dumpster](/dumpster-rental-pricing-jacksonville) has served Jacksonville landscaping projects since 2016 with 10, 15, and 20-yard containers from $299.
...
- **Sell online:** List on Facebook Marketplace, OfferUp, or Craigslist with photos, estimated weight, and rock type. Decorative rock is expensive to buy new, so used rock in good condition sells well in the Jacksonville area.
- **Give away:** Post on Nextdoor or community Facebook groups as "free landscape rocks, you haul." This is the fastest way to get rocks off your property at zero cost.
- **Landscape supply exchange:** Some landscape supply yards in Jacksonville accept clean decorative rock and may offer credit toward new materials.
...
## How to Get Rid of Extra Dirt from Your Yard
...
For clean fill dirt in good condition, posting "free fill dirt" or "dirt wanted" on community boards is remarkably effective in Jacksonville. Many construction projects, horse farms in the [Middleburg](/dumpster-rental-middleburg-fl) and [Green Cove Springs](/dumpster-rental-green-cove-springs-fl) areas, and homeowners working on their own yards actively search for fill dirt.
...
## How to Dispose of Pavers and Concrete
...
Because of these high weights, dumpster loads of landscaping materials fill the weight limit long before filling the volume. A [10-yard dumpster](/10-yard-dumpster-rental) filled to the brim with concrete would weigh far more than the weight limit allows. When disposing of heavy landscaping materials, it is important to discuss your specific materials with us so we can recommend the right approach, whether that is a single heavy-duty load, multiple smaller loads, or a combination of dumpster rental and other disposal methods.
...
We deliver throughout Northeast Florida including [St. Augustine](/dumpster-rental-st-augustine-fl), [Ponte Vedra](/dumpster-rental-ponte-vedra-fl), [Fleming Island](/dumpster-rental-fleming-island-fl), [Jacksonville Beach](/dumpster-rental-jacksonville-beach-fl), and [Fernandina Beach](/dumpster-rental-fernandina-beach-fl). For drainage-specific waste, see our guide on [yard drainage solutions and debris removal](/blog/yard-drainage-solutions-debris-removal).

[Book a dumpster online](https://app.icans.ai/customer-portal/904dumpster/book/) or call us at **(904) 240-5598**. See our [dumpster size guide](/dumpster-size-guide) to find the right container for your project.

## Frequently Asked Questions

### How do I dispose of rocks and dirt together?
...
### Can you take dirt to the dump in Jacksonville?
...
### How do I dispose of concrete pavers?
...
### What is a dirt bin rental?

A dirt bin rental is simply a roll-off dumpster used specifically for soil, dirt, and earth materials. At 904 Dumpster, our standard [10-yard](/10-yard-dumpster-rental), [15-yard](/15-yard-dumpster-rental), and [20-yard](/20-yard-dumpster-rental) dumpsters all accept dirt and soil. Weight limits apply due to the heaviness of soil and earth materials.

### How do I get rid of lava rocks from my yard?
