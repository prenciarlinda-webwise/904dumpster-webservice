...
export const SERVICES: ServicePage[] = [
  ...
  // ============================================
  {
    ...
    features: [
      'Compact 12\' x 8\' x 3.5\' dimensions',
  ...
  },
  {
    ...
    metaTitle: 'Demolition Services Jacksonville FL',
    metaDescription: 'Professional demolition services in Jacksonville FL. Shed, deck, pool, and interior demolition with debris removal.',
    keywords: [
    ...
    description: 'Professional demolition services with debris removal included. From sheds to decks to interior demo, we handle the entire project safely and efficiently.',
    features: [
