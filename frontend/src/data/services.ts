...
export const SERVICES: ServicePage[] = [
  ...
  },
  {
    ...
    metaDescription: 'Rent a 15 yard dumpster in Jacksonville FL for $325. Ideal for roofing projects & kitchen remodels. Same-day delivery available.',
    keywords: [
      '15 yard dumpster',
    ...
    description: 'Our 15 yard dumpster is the most popular size for roofing projects and medium-sized home renovations. This 15 cubic yard roll off container offers the perfect balance of capacity and accessibility for Jacksonville homeowners.',
    features: [
    ...
    faqs: [
      {
        ...
        answer: 'A 15 yard dumpster measures 14\' long x 7.5\' wide x 4.5\' high and holds about 5 pickup truck loads. This mid-size container fits standard driveways while offering excellent capacity for medium projects.',
      },
      {
        question: 'What does a 15 yard dumpster look like?',
        answer: 'A 15 yard dumpster is a rectangular metal container about the length of a sedan and chest-high (4.5 feet). It features a rear swing door for easy walk-in loading.',
        image: '/images/15-yard-dumpster.jpg',
      },
      {
        question: 'How much does a 15 yard dumpster cost in Jacksonville?',
        answer: 'At 904 Dumpster, our 15 yard costs $325 flat rate. Most Jacksonville competitors charge $400-$450 for the same size. Our price includes delivery, 5-day rental, pickup, and disposal up to 2 tons.',
      },
      {
        question: 'How many roofing squares fit in a 15 yard dumpster?',
        answer: 'A 15 yard dumpster holds 20-25 squares of roofing shingles (2,000-2,500 sq ft of roof). This makes it ideal for most single-story home roof replacements.',
      },
      {
        question: 'How many pickup truck loads fit in a 15 yard dumpster?',
        answer: 'A 15 yard dumpster holds approximately 5 full-size pickup truck loads of debris. It\'s perfect for kitchen remodels, bathroom renovations, and medium-sized cleanouts.',
      },
    ],
    customPage: true,
  },
