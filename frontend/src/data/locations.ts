...
export const LOCATIONS: Location[] = [
  ...
  },
  {
    ...
    whyChooseUs: [
      'Experience with narrow beach community streets',
      'Compact 10-yard dumpsters perfect for small driveways',
      'Knowledge of Atlantic Beach permit requirements',
      'Quick turnaround for vacation property projects',
      'Same-day delivery to all Atlantic Beach neighborhoods',
      'Careful placement to protect driveways and landscaping',
    ],
    commonProjects: [
      'Beach cottage renovations',
      'Hurricane preparation cleanouts',
