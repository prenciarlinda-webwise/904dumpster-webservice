...
const SITEMAP = {
  ...
  services: {
    title: 'Services',
    links: [
      { label: 'Residential Dumpster Rental', href: '/residential-dumpster-rental-jacksonville-fl' },
      { label: 'Commercial Dumpster Rental', href: '/commercial-dumpster-rental-jacksonville-fl' },
      { label: 'Construction Dumpster Rental', href: '/construction-dumpster-rental-jacksonville-fl' },
      { label: 'Concrete Disposal', href: '/concrete-disposal-dumpster-jacksonville-fl' },
